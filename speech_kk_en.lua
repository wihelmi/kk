...
STRINGS.RECIPE_DESC.KK_TRANSMITTER = KK_SETSTRING("简单粗暴", "Simple and Crude")
STRINGS.CHARACTERS.GENERIC.DESCRIBE.KK_TRANSMITTER = KK_SETSTRING("对棋子使用撬棍吧", "Use crowbar on chess")
